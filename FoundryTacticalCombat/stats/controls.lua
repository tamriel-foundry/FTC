...
function FTC.Stats:Controls()
	...
	FM.dtitle 		= FTC.UI:Label( 	"FTC_Report_DamageTitle", 			FM, 		{950,50}, 				{TOPLEFT,TOPLEFT,25,25}, 		"ZoFontWindowTitle", {1,1,1,1}, {0,1}, "FTC Damage Report", false )
	FM.htitle		= FTC.UI:Label( 	"FTC_Report_HealingTitle", 			FM, 		{950,50}, 				{BOTTOMLEFT,BOTTOMLEFT,25,25}, 	"ZoFontWindowTitle", {1,1,1,1}, {0,1}, "FTC Healing Report", false )
    ...
    header.total 	= FTC.UI:Label(    "FTC_Report_Ability_Total",  		header,  	{200,50},  				{LEFT,RIGHT,0,0,header.count},  FTC.UI:Font("esobold",20,true), {1,1,1,1}, {0,1}, GetString(FTC_Damage), false )
    header.dps 		= FTC.UI:Label(    "FTC_Report_Ability_DPS",  			header,  	{150,50},  				{LEFT,RIGHT,0,0,header.total},  FTC.UI:Font("esobold",20,true), {1,1,1,1}, {0,1}, GetString(FTC_DPS), false )
    ...
    header.max 		= FTC.UI:Label(    "FTC_Report_Ability_Max",   			header,  	{100,50},  				{LEFT,RIGHT,0,0,header.crit},  	FTC.UI:Font("esobold",20,true), {1,1,1,1}, {0,1}, GetString(FTC_Max), false )
...
--[[----------------------------------------------------------
	...
	function FTC.Stats.CreateAbility()
	    ...
	    control.total 	= FTC.UI:Label(    "FTC_Report_Ability"..counter.."_Total",  	control,  	{200,50},  					{LEFT,RIGHT,0,0,control.count},  	FTC.UI:Font("standard",20,true), {1,1,1,1}, {0,1}, "Total", false )
	    control.dps 	= FTC.UI:Label(    "FTC_Report_Ability"..counter.."_DPS",  		control,  	{150,50},  					{LEFT,RIGHT,0,0,control.total},  	FTC.UI:Font("standard",20,true), {1,1,1,1}, {0,1}, "DPS", false )
	    ...
	    control.max 	= FTC.UI:Label(    "FTC_Report_Ability"..counter.."_Max",   	control,  	{100,50},  					{LEFT,RIGHT,0,0,control.crit},  	FTC.UI:Font("standard",20,true), {1,1,1,1}, {0,1}, "Max", false )
